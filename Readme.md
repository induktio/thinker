...
Compiling
---------
Thinker can be compiled with mingw-w64 i686 GCC and the included CodeBlocks project. Note that mingw-w64 and mingw are not the same thing and that CodeBlocks comes bundled with the wrong one. GCC version 8.1.0 or later is recommended and can be found from [mingw-w64 project](https://sourceforge.net/projects/mingw-w64/files/).
