...
typedef int(__thiscall *FBuffer_write_cent_l3)(Buffer* This, char* text, RECT* rt, int len);
typedef int(__thiscall *FBuffer_write_right_l2)(Buffer* This, char* text, int x, int y, int len);
