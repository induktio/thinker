...
typedef int(__thiscall *FAlphaNet)(void* This);
typedef int(__thiscall *FAlphaNet_pid_2_idx)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_pid_2_who)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_who_2_pid)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_who_2_idx)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_pick_service)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_setup)(void* This, int a2);
typedef int(__thiscall *FAlphaNet_do_join_dialog_and_connect)(void* This, int a2, int a3);
typedef int(__thiscall *FAlphaNet_do_create_dialog_and_connect)(void* This, int a2, int a3, int a4);
