...
typedef int(__cdecl *Finterlude)(int event_id, const char* text, int a3, int a4);
...
typedef int(__cdecl *Fpopp)(
    const char* filename, const char* label, int a3, const char* pcx_filename, fp_none fn);
typedef int(__cdecl *Fpopb)(
    const char* label, int flags, int sound_id, const char* pcx_filename, Sprite* a5);
typedef int(__cdecl *Fpopm)(
    const char* filename, const char* label, int x, int y, fp_none fn);
typedef int (__cdecl *Fpop)(
    const char* filename, const char* label, int a3, int a4, int a5, fp_none fn);
typedef int (__cdecl *Fpops)(
    const char* filename, const char* label, int a3, int a4, int a5, Sprite* a6, int a7, int a8, fp_none fn);
...
extern tc_2int BaseWin_base_killed;
...
extern tc_1int Popup_ctor;
extern tc_1int Popup_close;
extern tc_2int Popup_show;
extern tc_1int Popup_hide;
extern tc_1int Popup_on_redraw;
extern tc_1int Popup_calculate_dimensions;
extern tc_1int Popup_on_post_window_init;
extern tc_3int Popup_on_redraw_nc;
extern tc_3int Popup_on_nc_hittest;
extern tc_1int Popup_new;
extern tc_1int Popup_on_adjust_button_width;
extern tc_3int Popup_on_adjust_button_placement;
extern tc_3int Popup_on_link_clicked;
extern tc_1int Popup_on_exec;
extern tc_1int Popup_on_dialog_back_draw;
extern tc_5int Popup_on_dialog_item_back_draw;
extern tc_1int Popup_on_draw_background;
extern tc_1int Popup_on_listbox_scroll_create;
extern tc_2int Popup_on_listbox_scroll_delete;
extern FPopup_start Popup_start;
extern tc_2int Popup_deleting_dtor;
extern tc_1int Popup_dtor;
extern tc_1int Popup_delete;
extern tc_6int Popup_start2;
extern fp_1int popup_wave_callback;
extern tc_3int Popup_start3;
extern tc_2int Popup_start4;

extern tc_1int BasePop_dtor;
extern tc_2int BasePop_deleting_dtor;
extern tc_1int BasePop_delete;
extern tc_2int BasePop_exec_cb;
extern tc_3int BasePop_item;
extern tc_1int BasePop_exec_alt;
extern tc_1int BasePop_ctor;
extern tc_1int BasePop_close;
extern tc_3int BasePop_init;
extern tc_2int BasePop_set_ok_text;
extern tc_2int BasePop_set_cancel_text;
extern tc_2int BasePop_set_def_ok_text;
extern tc_2int BasePop_set_def_cancel_text;
extern tc_2int BasePop_string;
extern tc_2int BasePop_button;
extern tc_2int BasePop_set_height;
extern tc_2int BasePop_set_width;
extern tc_3int BasePop_set_loc;
extern tc_2int BasePop_write_check;
extern tc_1int BasePop_read_check;
extern FBasePop_start BasePop_start;
extern tc_3int BasePop_exec;
extern tc_1int BasePop_calculate_dimensions;
extern tc_2int BasePop_on_button_clicked;
extern tc_2int BasePop_set_def_file;
extern tc_2int BasePop_on_key_down;
extern tc_3int BasePop_on_key_click;
extern tc_2int BasePop_on_key_up;
extern tc_2int BasePop_double_click;
extern tc_1int BasePop_init_class;
extern tc_1int BasePop_close_class;
extern tc_5int BasePop_set_string_font;
extern tc_5int BasePop_set_string_color;
extern tc_5int BasePop_set_string_color2;
extern tc_5int BasePop_set_string_color3;
extern tc_5int BasePop_set_string_color_hyper;
extern tc_4int BasePop_set_button_font;
extern tc_5int BasePop_set_button_color;
extern tc_5int BasePop_set_button_color2;
extern tc_5int BasePop_set_button_color3;
extern tc_5int BasePop_set_def_string_font;
extern tc_5int BasePop_set_def_string_color;
extern tc_5int BasePop_set_def_string_color2;
extern tc_5int BasePop_set_def_string_color3;
extern tc_5int BasePop_set_def_string_color_hyper;
extern tc_4int BasePop_set_def_button_font;
extern tc_5int BasePop_set_def_button_color;
extern tc_5int BasePop_set_def_button_color2;
extern tc_5int BasePop_set_def_button_color3;
extern fp_none BasePop_on_modal;
extern tc_1int BasePop_fallout;
extern tc_1int BasePop_on_redraw;
extern tc_1int BasePop_new;
extern tc_6int BasePop_set_external_window;
extern tc_6int BasePop_set_def_external_window;
extern tc_3int BasePop_on_left_down;

extern tc_1int ListBox_dtor;
extern tc_2int ListBox_ctor;
extern tc_1int ListBox_close2;
extern tc_1int ListBox_close;
extern tc_2int ListBox_set_selected_id;
extern tc_3int ListBox_set_selected_pos;
extern tc_1int ListBox_calculate_dimensions;
extern tc_5int ListBox_attach;
extern tc_3int ListBox_on_left_down;
extern tc_2int ListBox_on_key_down;
extern tc_2int ListBox_draw_item;
extern tc_1int ListBox_on_redraw;
extern tc_3int ListBox_on_scrolling;
extern tc_1int ListBox_on_left_double_click;
extern tc_3int ListBox_item;
extern tc_1int ListBox_update_changes;
extern tc_3int ListBox_on_mouse_move;
extern tc_1int ListBox_on_mouse_leave;
...
typedef int(__cdecl *Fparse_says)(size_t index, const char* src, int gender, int plural);
