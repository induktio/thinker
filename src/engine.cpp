...
tc_2int BaseWin_base_killed                = (tc_2int              )0x41A620;
tc_2int BaseWin_check_base                 = (tc_2int              )0x41A7A0;
tc_4int BaseWin_check_loc                  = (tc_4int              )0x41A7E0;
tc_2int BaseWin_check_veh                  = (tc_2int              )0x41A8B0;
...
tc_2int DeletionList_clear                 = (tc_2int              )0x52DCD0;
tc_3int DeletionList_convert               = (tc_3int              )0x52DDC0;
tc_2int DeletionList_add_deletion          = (tc_2int              )0x52DE70;
Fpopm popm                                 = (Fpopm                )0x59D3B0;
Fhas_abil has_abil                         = (Fhas_abil            )0x5BF1F0;
Fpop X_pop                                 = (Fpop                 )0x5BF480;
Fpops X_pops                               = (Fpops                )0x5BF930;
...
tc_1int Popup_ctor = (tc_1int)0x4048A0;
tc_1int Popup_close = (tc_1int)0x404900;
tc_2int Popup_show = (tc_2int)0x404920;
tc_1int Popup_hide = (tc_1int)0x404A80;
tc_1int Popup_on_redraw = (tc_1int)0x404B00;
tc_1int Popup_calculate_dimensions = (tc_1int)0x404B10;
tc_1int Popup_on_post_window_init = (tc_1int)0x404EF0;
tc_3int Popup_on_redraw_nc = (tc_3int)0x404F80;
tc_3int Popup_on_nc_hittest = (tc_3int)0x404F90;
tc_1int Popup_new = (tc_1int)0x404FB0;
tc_1int Popup_on_adjust_button_width = (tc_1int)0x405020;
tc_3int Popup_on_adjust_button_placement = (tc_3int)0x405050;
tc_3int Popup_on_link_clicked = (tc_3int)0x4050A0;
tc_1int Popup_on_exec = (tc_1int)0x405910;
tc_1int Popup_on_dialog_back_draw = (tc_1int)0x405B10;
tc_5int Popup_on_dialog_item_back_draw = (tc_5int)0x405B20;
tc_1int Popup_on_draw_background = (tc_1int)0x405C80;
tc_1int Popup_on_listbox_scroll_create = (tc_1int)0x406260;
tc_2int Popup_on_listbox_scroll_delete = (tc_2int)0x406330;
FPopup_start Popup_start = (FPopup_start)0x406380;
tc_2int Popup_deleting_dtor = (tc_2int)0x406BD0;
tc_1int Popup_dtor = (tc_1int)0x406C00;
tc_1int Popup_delete = (tc_1int)0x4070D0;
tc_6int Popup_start2 = (tc_6int)0x43EF70;
fp_1int popup_wave_callback = (fp_1int)0x4456B0;
tc_3int Popup_start3 = (tc_3int)0x559040;
tc_2int Popup_start4 = (tc_2int)0x5A5990;

tc_1int BasePop_dtor = (tc_1int)0x4064D0;
tc_2int BasePop_deleting_dtor = (tc_2int)0x406B40;
tc_1int BasePop_delete = (tc_1int)0x4070B0;
tc_2int BasePop_exec_cb = (tc_2int)0x558FC0;
tc_3int BasePop_item = (tc_3int)0x558FE0;
tc_1int BasePop_exec_alt = (tc_1int)0x5A5900;
tc_1int BasePop_ctor = (tc_1int)0x600860;
tc_1int BasePop_close = (tc_1int)0x600F00;
tc_3int BasePop_init = (tc_3int)0x6015B0;
tc_2int BasePop_set_ok_text = (tc_2int)0x6017A0;
tc_2int BasePop_set_cancel_text = (tc_2int)0x601820;
tc_2int BasePop_set_def_ok_text = (tc_2int)0x6018A0;
tc_2int BasePop_set_def_cancel_text = (tc_2int)0x601910;
tc_2int BasePop_string = (tc_2int)0x601980;
tc_2int BasePop_button = (tc_2int)0x6019F0;
tc_2int BasePop_set_height = (tc_2int)0x601AC0;
tc_2int BasePop_set_width = (tc_2int)0x601B20;
tc_3int BasePop_set_loc = (tc_3int)0x601B80;
tc_2int BasePop_write_check = (tc_2int)0x601BB0;
tc_1int BasePop_read_check = (tc_1int)0x601BD0;
FBasePop_start BasePop_start = (FBasePop_start)0x601BF0;
tc_3int BasePop_exec = (tc_3int)0x602600;
tc_1int BasePop_calculate_dimensions = (tc_1int)0x603800;
tc_2int BasePop_on_button_clicked = (tc_2int)0x604300;
tc_2int BasePop_set_def_file = (tc_2int)0x6043D0;
tc_2int BasePop_on_key_down = (tc_2int)0x604410;
tc_3int BasePop_on_key_click = (tc_3int)0x604490;
tc_2int BasePop_on_key_up = (tc_2int)0x6044B0;
tc_2int BasePop_double_click = (tc_2int)0x6044D0;
tc_1int BasePop_init_class = (tc_1int)0x604590;
tc_1int BasePop_close_class = (tc_1int)0x604680;
tc_5int BasePop_set_string_font = (tc_5int)0x6046F0;
tc_5int BasePop_set_string_color = (tc_5int)0x604730;
tc_5int BasePop_set_string_color2 = (tc_5int)0x604760;
tc_5int BasePop_set_string_color3 = (tc_5int)0x604790;
tc_5int BasePop_set_string_color_hyper = (tc_5int)0x6047C0;
tc_4int BasePop_set_button_font = (tc_4int)0x6047F0;
tc_5int BasePop_set_button_color = (tc_5int)0x604830;
tc_5int BasePop_set_button_color2 = (tc_5int)0x604860;
tc_5int BasePop_set_button_color3 = (tc_5int)0x604890;
tc_5int BasePop_set_def_string_font = (tc_5int)0x6048C0;
tc_5int BasePop_set_def_string_color = (tc_5int)0x604900;
tc_5int BasePop_set_def_string_color2 = (tc_5int)0x604930;
tc_5int BasePop_set_def_string_color3 = (tc_5int)0x604960;
tc_5int BasePop_set_def_string_color_hyper = (tc_5int)0x604990;
tc_4int BasePop_set_def_button_font = (tc_4int)0x6049C0;
tc_5int BasePop_set_def_button_color = (tc_5int)0x6049F0;
tc_5int BasePop_set_def_button_color2 = (tc_5int)0x604A20;
tc_5int BasePop_set_def_button_color3 = (tc_5int)0x604A50;
fp_none BasePop_on_modal = (fp_none)0x604A80;
tc_1int BasePop_fallout = (tc_1int)0x604A90;
tc_1int BasePop_on_redraw = (tc_1int)0x604AB0;
tc_1int BasePop_new = (tc_1int)0x604E40;
tc_6int BasePop_set_external_window = (tc_6int)0x605010;
tc_6int BasePop_set_def_external_window = (tc_6int)0x6050F0;
tc_3int BasePop_on_left_down = (tc_3int)0x605130;

tc_1int ListBox_dtor = (tc_1int)0x4080B0;
tc_2int ListBox_ctor = (tc_2int)0x609DB0;
tc_1int ListBox_close2 = (tc_1int)0x609EC0;
tc_1int ListBox_close = (tc_1int)0x609F20;
tc_2int ListBox_set_selected_id = (tc_2int)0x609FA0;
tc_3int ListBox_set_selected_pos = (tc_3int)0x60A020;
tc_1int ListBox_calculate_dimensions = (tc_1int)0x60A1E0;
tc_5int ListBox_attach = (tc_5int)0x60A670;
tc_3int ListBox_on_left_down = (tc_3int)0x60AA60;
tc_2int ListBox_on_key_down = (tc_2int)0x60AF90;
tc_2int ListBox_draw_item = (tc_2int)0x60B530;
tc_1int ListBox_on_redraw = (tc_1int)0x60C350;
tc_3int ListBox_on_scrolling = (tc_3int)0x60C5D0;
tc_1int ListBox_on_left_double_click = (tc_1int)0x60C710;
tc_3int ListBox_item = (tc_3int)0x60C920;
tc_1int ListBox_update_changes = (tc_1int)0x60C9B0;
tc_3int ListBox_on_mouse_move = (tc_3int)0x60CBC0;
tc_1int ListBox_on_mouse_leave = (tc_1int)0x60CE10;
...
fp_2int vector_dist              = (fp_2int)0x4F8090;
...
fp_2int x_dist                   = (fp_2int)0x579790;
...
fp_1int stack_sort_2             = (fp_1int)0x5B8C90;
