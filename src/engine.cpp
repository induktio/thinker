...
int* game_more_rules = (int*)0x9A681C;
int* diff_level = (int*)0x9A64C4;
int* expansion_enabled = (int*)0x9A6488;
int* multiplayer_active = (int*)0x93F660; // DirectPlay, Internet (TCP/IP)
int* pbem_active = (int*)0x93A95C; // HotSeat / PBEM
int* human_players = (int*)0x9A64E8;
int* current_turn = (int*)0x9A64D4;
int* current_year = (int*)0x9A64D8;
...
int* MissionYearCurrent = (int*)0x9A64D8;
int* StartingMissionYear = (int*)0x94B4D0;
int* EndingMissionYear = (int*)0x94B4D4;
...
FGeneric Console_editor_scen_rules             = (FGeneric               )0x4DC520;
